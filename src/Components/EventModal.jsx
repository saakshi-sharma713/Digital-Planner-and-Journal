  ...
  return (
    <div className="min-h-screen flex-col  items-center justify-center bg-gray-100 p-10">
        ...
        <div className="flex flex-col justify-center items-center p-10 ">
            ...
            <img src={image} width="80" className="absolute z-1 left-155 top-5 drop-shadow-md rotate-[-10deg]
"/>
      <div
      ...
      >
        ...
        <div className="flex justify-end gap-4">
          <button
            onClick={handleSave}
            className="bg-[#333] text-white px-6 py-3 rounded hover:bg-[#444] text-lg"
